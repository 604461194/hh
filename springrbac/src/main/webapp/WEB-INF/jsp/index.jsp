...
<link rel="stylesheet" type="text/css"
	href="/springrbac/js/easyui/themes/bootstrap/easyui.css" />
<!-- 图标样式 -->
<link rel="stylesheet" type="text/css"
	href="/springrbac/js/easyui/themes/icon.css" />

<script type="text/javascript" src="/springrbac/js/jquery-1.8.3.js"></script>
<!-- easyUI核心类库 -->
<script type="text/javascript"
	src="/springrbac/js/easyui/jquery.easyui.min.js"></script>
<!-- 本地化 -->
<script type="text/javascript"
	src="/springrbac/js/easyui/locale/easyui-lang-zh_CN.js"></script>
</head>
...
<body class="easyui-layout">
    ...
    <div id="west" data-options="region:'west',split:false"
		style="width:200px;">
		<ul id="funtree" class="easyui-tree" data-options="animate:true,lines:true,url:'/springrbac/user/getFunTree?fcode=0'"></ul>
	</div> 
	...
	<script type="text/javascript">
		$(function(){
			...
			$("#loginout").click(function(){
				alert("退出成功");
				location.href="/springrbac/login/loginOut";
				
			});
			
			//初始化登陆用户信息
			$.post("/springrbac/user/getSessionUser?fcode=0",function(user){
